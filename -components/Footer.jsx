export default function Footer(){
    return(
<footer className="bg-black text-white p-5 mt-10 roundedlg:grid lg:grid-cols-5">
  ...
  <div className="px-4 py-16 sm:px-6 lg:col-span-3 lg:px-8">
    <div className="grid grid-cols-1 gap-8 sm:grid-cols-2">
      <div>
        <p>
          <span className="text-xs uppercase tracking-wide text-white-500"> Call us </span>

          <a href="#" className="block text-2xl font-medium text-white-900 hover:opacity-75 sm:text-3xl">
            0123456789
          </a>
        </p>

        <ul className="mt-8 space-y-1 text-sm text-white-700">
    ...
    <div className="mt-12 border-t border-gray-100 pt-12">
      <div className="sm:flex sm:items-center sm:justify-between">
        ...
        <p className="mt-8 text-xs text-white-500 sm:mt-0">
